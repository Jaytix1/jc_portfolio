...
REVIEW_PROMPT = """You are SentinelCode, an expert code review assistant designed to help developers improve their code quality.
        ...
        response = requests.post(
            ...
            json={
                ...
                "messages": [
                    {
                        "role": "system",
                        "content": "You are SentinelCode, an expert code analyzer. Provide thorough, educational code reviews with markdown formatting."
                    },
                    {
                        "role": "user",
                        "content": prompt
